...
public class InterleavedReadViewU16 {
    ...
    public static long getCPtr(InterleavedReadViewU16 interleavedReadViewU16) {
    ...
    public InterleavedReadViewU16(int i, int i2, int i3, SWIGTYPE_p_unsigned_short sWIGTYPE_p_unsigned_short) {
        this(GcamModuleJNI.new_InterleavedReadViewU16__SWIG_4(i, i2, i3, SWIGTYPE_p_unsigned_short.getCPtr(sWIGTYPE_p_unsigned_short)), true);
    }

    public InterleavedReadViewU16(int i, int i2, int i3, SWIGTYPE_p_unsigned_short sWIGTYPE_p_unsigned_short, long j) {
        this(GcamModuleJNI.new_InterleavedReadViewU16__SWIG_5(i, i2, i3, SWIGTYPE_p_unsigned_short.getCPtr(sWIGTYPE_p_unsigned_short), j), true);
    }

    public InterleavedReadViewU16(long j, boolean z) {
        this.swigCMemOwn = z;
        this.swigCPtr = j;
    }
